    ...
    <div class="card card-accent-secondary">
        ...
        <div class="card-header">
            ...
            <div class="card-actionbar">
                @can('create carriers')
                    <a href="{{ route('shop.admin.zone.create') }}" class="btn btn-sm btn-outline-success float-right">
                        {!! icon('+') !!}
                        {{ __('Create Zone') }}
                    </a>
                @endcan
                ...
                @foreach($zones as $zone)
                    <tr>
                        <td>
                            ...
                            @can('view zones')
                                <a href="{{ route('shop.admin.zone.show', $zone) }}">{{ $zone->name }}</a>
                            @else
                                {{ $zone->name }}
                            @endcan
                            </span>
                        ...
                        <td>
                            @can('edit zones')
                                <a href="{{ route('shop.admin.zone.edit', $zone) }}"
                                   class="btn btn-xs btn-outline-primary btn-show-on-tr-hover float-right">{{ __('Edit') }}</a>
                            @endcan

                            @can('delete zones')
                                {{ Form::open([
                                    'url' => route('shop.admin.zone.destroy', $zone),
