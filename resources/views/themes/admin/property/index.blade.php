        ...
        <div class="card-header">
            ...
            <div class="card-actionbar">
                @can('create properties')
                    <a href="{{ route('shop.admin.property.create') }}" class="btn btn-sm btn-outline-success float-right">
                        {!! icon('+') !!}
                        {{ __('New Property') }}
                    </a>
                @endcan
                ...
                @foreach($properties as $property)
                    <tr>
                        <td>
                            ...
                            @can('view properties')
                                <a href="{{ route('shop.admin.property.show', $property) }}">{{ $property->name }}</a>
                            @else
                                {{ $property->name }}
                            @endcan
                            </span>
                        ...
                        <td>
                            @can('edit properties')
                                <a href="{{ route('shop.admin.property.edit', $property) }}"
                                   class="btn btn-xs btn-outline-primary btn-show-on-tr-hover float-right">{{ __('Edit') }}</a>
                            @endcan

                            @can('delete properties')
                                {{ Form::open([
                                    'url' => route('shop.admin.property.destroy', $property),
