        ...
        <div class="card-header">
            ...
            <div class="card-actionbar">
                @can('create payment methods')
                    <a href="{{ route('shop.admin.payment-method.create') }}" class="btn btn-sm btn-outline-success float-right">
                        {!! icon('+') !!}
                    ...
                    <tr>
                        <td>
                            ...
                            @can('view payment methods')
                                    <a href="{{ route('shop.admin.payment-method.show', $paymentMethod) }}">{{ $paymentMethod->getName() }}</a>
                                @else
                        ...
                        <td>
                            @can('edit payment methods')
                                <a href="{{ route('shop.admin.payment-method.edit', $paymentMethod) }}"
                                   class="btn btn-xs btn-outline-primary btn-show-on-tr-hover float-right">{{ __('Edit') }}</a>
                            @endcan

                            @can('delete payment methods')
                                {{ Form::open([
                                    'url' => route('shop.admin.payment-method.destroy', $paymentMethod),
