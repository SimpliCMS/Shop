@foreach($propertyValues as $propertyValue)
    <div class="btn-group btn-group-sm mb-1" role="group">
        @can('edit property values')
            <a href="{{ route('shop.admin.property_value.edit', [$property, $propertyValue]) }}"
        ...
        <div class="dropdown-menu">
            @can('delete property values')
                {{ Form::open([
                            'url' => route('shop.admin.property_value.destroy', [$property, $propertyValue]),
...
@can('create property values')
    <a href="{{ route('shop.admin.property_value.create', $property) }}"
